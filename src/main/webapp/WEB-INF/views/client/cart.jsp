									...
									<tbody>
										<c:forEach items="${sessionScope.cart}" var="cart">
											<tr>
												...
												<td>
													<h5 style="color: #41B314; font-weight: bold;">${Math.round(cart.value.unitPrice)} đ</h5>
													<c:if
														test="${cart.value.productDTO.saleDTO.salePercent > 0}">
														<p
															style="font-size: 16px; padding-top: 7px; text-decoration: line-through;">${Math.round(cart.value.productDTO.price)} đ</p>
													</c:if>
												</td>
												<td>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-6">
										<div class="shippingbox">
											<div class="subtotal">
												<h5>Sub Total:</h5>
												<span>${Math.round(sessionScope.subTotal)} đ</span>
											</div>
											<div class="subtotal">
												<h5>Shipping Fee:</h5>
												<span> 0 </span>
											...
											<div class="grandtotal">
												<h5>GRAND TOTAL</h5>
												<span>${Math.round(sessionScope.grandTotal)} đ</span>
											</div>
											<c:if test="${sessionScope.user != null}">
												<c:if
