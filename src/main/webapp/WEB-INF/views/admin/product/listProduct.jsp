												...
												<div class="panel-heading">
													...
													<p class="demo-button">
														...
														<a class="btn btn-success" href="product-list-by-category?categoryId=3"
															...
															background-color: #41B314; padding: 4px 8px; text-decoration: none; border: none; margin-left: 7px;">Longines</a>
														<a class="btn btn-info" href="product-list-by-category?categoryId=2"
															...
															background-color: #E4CB10; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Casio</a> 
														<a class="btn btn-primary" href="product-list-by-category?categoryId=1"
															...
															background-color: #00AAFF; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Doxa</a> 
														<a class="btn btn-warning" href="product-list-by-category?categoryId=4"
															...
															background-color: #D9534F; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Citizen</a> 
														<a class="btn btn-danger" href="product-list-by-category?categoryId=5"
															...
															background-color: #5BC0DE; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Orient</a> 
														<a class="btn btn-danger" href="product-list-by-category?categoryId=6"
															...
															background-color: gray; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Seiko</a>
													</p>
													<div class="right">
														<button type="submit">
															...
															<c:forEach items="${products}" varStatus="loop"
																...
																<tr>
																	...
																	<td style="vertical-align: middle;"><span
																		style="color: #41B314; font-weight: bold;">${Math.round(product.price - (product.price * (product.saleDTO.salePercent / 100)))} đ</span><br />
																		<c:if test="${product.saleDTO.salePercent != 0}">
																		<span style="text-decoration: line-through;'">${Math.round(product.price)} đ</span>
																		</c:if>
																	</td>
																	...
																	<td style="vertical-align: middle;"><img
																		style="width: 70%;" src="<c:url value="/resource/client/images/products/image/${product.image}" />"></td>
