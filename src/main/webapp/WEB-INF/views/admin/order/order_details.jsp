					...
					<div class="panel panel-headline">
						...
						<div class="panel-body no-padding">
							<table class="shop-table" style="padding: 30px;">
										...
										<tr>
											<td><a
												href="product-details?productId=${item.productDTO.productId}"><img
													src="<c:url value="/resource/client/images/products/image/${item.productDTO.image}" />"  alt=""></a></td>
											<td>
											...
											<td>
												<h5 style="color: #41B314; font-weight: bold;">${Math.round(item.unitPrice)} đ</h5>
												<c:if test="${item.productDTO.saleDTO.salePercent > 0}">
													<p
														style="font-size: 16px; padding-top: 7px; text-decoration: line-through;">${Math.round(item.productDTO.price)} đ</p>
												</c:if>
											</td>
											...
											<td>
												<h5>
													<strong class="red" style="color: red;"> ${Math.round(item.unitPrice *
														item.quantity)} đ</strong>
												</h5>
											</td>
											<td><select>
								...
								<tfoot>
									<tr>
										<td colspan="6"><span class="pull-left">Sub Total: <span style="color: red;">${Math.round(order.priceTotal)} đ</span></span><br /> <span
											class="pull-left">Fee: <span style="color: red;">0</span></span><br /> <span  
											class="pull-left" style="font-size: 22px;">Grand
												Total: <span style="color: red;">${Math.round(order.priceTotal)} đ</span>
										</span>
